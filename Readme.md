...
4. Generated locally from a small reproducible script: the Oceananigans section of `06_tripolar_fold.ipynb` reads `oceananigans_tripolar.nc`, built by `scripts/generate_oceananigans_tripolar.jl` (Oceananigans.jl `TripolarGrid`).
